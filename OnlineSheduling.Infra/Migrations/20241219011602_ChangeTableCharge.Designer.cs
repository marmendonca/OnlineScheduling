...
namespace OnlineScheduling.Infra.Migrations
{
    ...
    [Migration("20241219011602_ChangeTableCharge")]
    partial class ChangeTableCharge
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineScheduling.Domain.Entities.Charge", b =>
                {
                    ...
                    b.Property<Guid?>("EfiBankChargeId")
            ...
            modelBuilder.Entity("OnlineScheduling.Domain.Entities.EfiBankCharge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("EfiBankCharge", (string)null);
                });
            ...
            modelBuilder.Entity("OnlineScheduling.Domain.Entities.Charge", b =>
                {
                    b.HasOne("OnlineScheduling.Domain.Entities.Schedule", "Schedule")
                        .WithOne("Charges")
                        .HasForeignKey("OnlineScheduling.Domain.Entities.Charge", "ScheduleId")
