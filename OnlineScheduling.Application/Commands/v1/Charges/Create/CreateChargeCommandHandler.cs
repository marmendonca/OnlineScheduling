...
public sealed class CreateChargeCommandHandler(
    ...
    IScheduleService scheduleService) : IRequestHandler<CreateChargeCommand, CreateChargeCommandResponse>
{
    ...
    private async Task<CreateChargeCommandResponse> CreateChargeAsync(Domain.Entities.Customer customer, int scheduleId, decimal value)
    {
    ...
    {
        await scheduleService.ChangeToPendingPaymentAsync(scheduleId);
    }
}